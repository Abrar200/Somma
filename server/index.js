...
function formatApplicationEmail(data) {
  const position = data.position || data.full_name ? data.position : 'General Application';
...
app.post('/api/send-application', async (req, res) => {
  try {
    ...
    const mailOptions = {
      ...
      to: 'info@somma.au, abrarshahriar360@yahoo.com', // Change this to your actual receiving email
